...
public class SortedMapTest extends TestCase {
  ...
  public void testConstruction() {
    ...
    assertEquals("A", map.apply(1));
    assertEquals("B", map.apply(2));
  }
  ...
  public void testOverwrite() {
    ...
    map = map.put(1, 1);
    map = map.put(2, 2);
    assertEquals(Integer.valueOf(1), map.apply(1));
    assertEquals(Integer.valueOf(2), map.apply(2));
    map = map.put(2, 3);
    assertEquals(2, map.size());
    assertEquals(Integer.valueOf(1), map.apply(1));
    assertEquals(Integer.valueOf(3), map.apply(2));
    ...
    for (int i = 0; i < N; i++)
      assertEquals(Integer.valueOf(i), map.apply(i));
    ...
    for (int i = 0; i < 2 * N; i++)
      assertEquals(Integer.valueOf(i + 777), map.apply(i));
  }
  ...
  public void testHashVersusSorted() {
    ...
    for (int i = 0; i <= N; i++) {
      ...
      assertEquals(mapHash.apply(key), mapSorted.apply(key));
