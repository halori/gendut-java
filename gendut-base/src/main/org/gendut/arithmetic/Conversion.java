...
/**
 * Static library that provides {@link LargeInteger} base conversion from/to any
...
class Conversion {
    ...
    /** @see LargeInteger#toString(int) */
    static String bigInteger2String(LargeInteger val, int radix) {
        int sign = val.sign;
     ...
     * 
     * @see LargeInteger#toString()
     * @see LargeDecimal#toString()
     */
    static String toDecimalScaledString(LargeInteger val, int scale) {
        int sign = val.sign;
        int numberLength = val.numberLength;
        int digits[] = val.digits;
    ...
    /** @see LargeInteger#doubleValue() */
    static double bigInteger2Double(LargeInteger val) {
        // val.bitLength() < 64
